...
- **Fix matte** opens the reference in Inker with the cutout already folded into its alpha, as one
  ...
  [Inker](08-inker.md#fixing-a-matte).
...
[Installation](17-installation.md#gltfpack). When it is there this panel offers the whole list, and
...
[The library and jobs](13-library-and-jobs.md#storage-and-pruning).
