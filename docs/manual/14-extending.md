...
pipeline and not two. See [VRAM modes](10-configuration.md#vram-modes).
...
[Optional image models and style LoRAs](09-installation.md#optional-image-models-and-style-loras).
...
**Sheet planning.** As described in [Sheet planning](13-pipelines.md#sheet-planning), the grid is
