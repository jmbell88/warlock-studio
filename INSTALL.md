...
2. Under **Assets**, download `WarlockSetup-v0.0.37.exe` (version numbers change between releases) — a single file, size **about 810 MB**. There is nothing to unzip and no other file to fetch alongside it. Its SHA-256 is **`6cf2899df4b31f4505d3ba8eaa82c6b3c1a9135ac989e47928c6f73f7deb3efc`**; the release page lists the current build's actual hash.
